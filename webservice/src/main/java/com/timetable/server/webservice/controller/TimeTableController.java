...
public class TimeTableController
{
	...
	public @ResponseBody
	Output generateTimeTable(@RequestBody Input input)
	{
		ObjectMapper objectMapper = new ObjectMapper();
		Output output = null;
		try
		{
			output = objectMapper.readValue(getRawOutputJson(), Output.class);
		}
		catch (IOException e)
		{
			e.printStackTrace();
	...
	public static void main(String[] args)
	{
		...
		try
		{
			Input rawInput = objectMapper.readValue(input, Input.class);
			TimeTableController obj = new TimeTableController();
			//Output rawOutput = obj.generate(rawInput);
